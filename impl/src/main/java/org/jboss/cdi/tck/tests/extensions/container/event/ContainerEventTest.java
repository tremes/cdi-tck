...
public class ContainerEventTest extends AbstractTest {
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = BEAN_DISCOVERY, id = "da"), @SpecAssertion(section = PROCESS_INJECTION_TARGET, id = "aaa") })
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = PROCESS_BEAN, id = "ca"), @SpecAssertion(section = BEAN_DISCOVERY, id = "fb") })
