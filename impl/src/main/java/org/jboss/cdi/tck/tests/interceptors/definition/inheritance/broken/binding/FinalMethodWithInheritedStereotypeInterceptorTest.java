...
public class FinalMethodWithInheritedStereotypeInterceptorTest extends AbstractTest {

    @ShouldThrowException(DeploymentException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClassDefinition(FinalMethodWithInheritedStereotypeInterceptorTest.class)
    ...
    public void testFinalClassWithInheritedStereotypeInterceptor() throws Exception {
    }
}
