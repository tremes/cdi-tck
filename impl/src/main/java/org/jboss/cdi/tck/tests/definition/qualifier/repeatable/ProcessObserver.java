...
public class ProcessObserver {
    ...
    private EventMetadata processBMetadata;
    private EventMetadata processABMetadata;
    ...
    public void observeProcessA(@Observes @Start("A") Process process, EventMetadata metadata) {
        ...
        System.out.println("EVENT METADATA IN A " + metadata.getQualifiers().size());
    }

    public void observeProcessB(@Observes @Start("B") Process process, EventMetadata metadata) {
        processBObserved++;
        System.out.println("OBSERVED B");
        processBMetadata = metadata;
        System.out.println("EVENT METADATA IN B " + metadata.getQualifiers().size());
    }

    public void observeProcessAB(@Observes @Start("A") @Start("B") Process process, EventMetadata metadata) {
        processABObserved++;
        System.out.println("OBSERVED AB");
        processABMetadata = metadata;
        System.out.println("EVENT METADATA IN AB " + metadata.getQualifiers().size());
