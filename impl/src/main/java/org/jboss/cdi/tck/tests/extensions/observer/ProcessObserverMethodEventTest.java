...
public class ProcessObserverMethodEventTest extends AbstractTest {
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = PROCESS_OBSERVER_METHOD, id = "aaa"), @SpecAssertion(section = BEAN_DISCOVERY, id = "i") })
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = PROCESS_OBSERVER_METHOD, id = "ba"), @SpecAssertion(section = BEAN_DISCOVERY, id = "i") })
